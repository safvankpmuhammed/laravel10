            ...
            <section class="footer-top padding-y">
                <div class="row">
                    ...
                    <aside class="col-sm-2 col-md-2">
                        <h6 class="title">Ekart</h6> <a href="#" class="d-block mb-2" data-abc="true"><img class="img-responsive" src="{{ 'https://i.imgur.com/nkZP7fe.png' }}" height="40"></a> <a href="#" class="d-block mb-2" data-abc="true"><img class="img-responsive" src="{{ 'https://i.imgur.com/47q2YGt.png' }}" height="40" width="123"></a>
                    </aside>
                </div>
            </section>
            <section class="footer-copyright border-top">
                <p class="float-left text-muted"> &copy; {{date('Y')}} Ekart All rights resetved </p>
